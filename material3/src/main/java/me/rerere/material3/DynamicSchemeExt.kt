...
fun DynamicScheme.toColorScheme(): ColorScheme {
    ...
    return if (isDark) {
        darkColorScheme(
            ...
            // tertiaryFixed etc. require compileSdk >= 37; mapped to primary fallback
            tertiaryFixed = Color(s.primaryFixed),
            tertiaryFixedDim = Color(s.primaryFixedDim),
            onTertiaryFixed = Color(s.onPrimaryFixed),
            onTertiaryFixedVariant = Color(s.onPrimaryFixedVariant),
        )
    } else {
        lightColorScheme(
            primary = Color(s.primary),
